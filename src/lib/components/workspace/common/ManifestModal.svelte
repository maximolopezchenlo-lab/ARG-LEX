			...
			<div class=" flex flex-col w-full sm:flex-row sm:justify-center sm:space-x-6">
				...
				>
					<div class="px-1 text-sm">
						<div class="my-2">
							{$i18n.t(
								'The developers behind this system are dedicated to legal excellence. Your feedback drives ARG-LEX forward.'
							)}
						</div>

						<div class="my-2">
							{$i18n.t(
								'ARG-LEX architecture ensures zero-trust privacy. Contributions support local legal tech sovereignty.'
							)}
						</div>
